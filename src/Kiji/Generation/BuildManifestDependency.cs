...
/// markdown file under one content-set scope, key = the contents-relative directory
/// the collection reads, empty for the whole tree). File dependencies also carry the
